...
""" 
    IF YOU HAVE ADDITIONAL MODULES TO ADD THAT WILL MODIFY THE FUNCTIONALITY
    OF THE CAMERA PROCESSING, MODIFY IT IN camera_subscriber_node.py

    IF YOU ARE ADDING ADDITIONAL FUNCTIONALITY OF ANY TYPE, SPEAK TO ALEX RESURRECCION
    OR SOMEONE WHO IS HAVE PROVIDED PRIMARY CONTRIBUTIONS TO THE CODEBASE

    MODULARIZATION IS HIGLY STRESSED IN ORDER TO PREVENT PROBLEMS FROM OCCURING DUE TO
    INTEGRATION
"""

"""
    MAKES USE OF THE sensor_msgs.msg.CompressedImage
    THIS DOES NOT MAKE USE OF THE sensor_msgs.msg.Image
"""
